...
use common\components\activecollab\response\TeamResponse;

class TeamRequest extends RequestInterface
{
    /**
     * @var string
     */
    protected $method = '/teams/{team_id}';
    ...
    {
        return new TeamResponse($status, $data);
    }
}